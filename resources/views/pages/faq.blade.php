                    ...
                    <div class="">
                        <div class="swiper-slide mb-4">
                            <div class="testi-card">
                                <div class="user-info mb-30 d-flex align-items-center">
                                    ...
                                    <h2 class="txt  text-uppercase"> How involved will I be in the design process? </h2>
                                </div>
                        ...
                        <div class="swiper-slide mb-4">
                            <div class="testi-card">
                                <div class="user-info mb-30 d-flex align-items-center">
                                    <img src="{{ asset('assets/img/qt.svg') }}" alt="" class="qt th-40 me-80">
                                    <h2 class="txt  text-uppercase"> How do you handle procurement and installation? </h2>
                                </div>
                                <div class="main-txt cr-999 sub-font">
                        ...
                        <div class="swiper-slide mb-4">
                            <div class="testi-card">
                                <div class="user-info mb-30 d-flex align-items-center">
                                    <img src="{{ asset('assets/img/qt.svg') }}" alt="" class="qt th-40 me-80">
                                    <h2 class="txt  text-uppercase">How long will the design process take? </h2>
                                </div>
                                <div class="main-txt cr-999 sub-font">
                        ...
                        <div class="swiper-slide mb-4">
                            <div class="testi-card">
                                <div class="user-info mb-30 d-flex align-items-center">
                                    <img src="{{ asset('assets/img/qt.svg') }}" alt="" class="qt th-40 me-80">
                                    <h2 class="txt  text-uppercase"> What if I need to make changes during the project?</h2>
                                </div>
                                <div class="main-txt cr-999 sub-font">
