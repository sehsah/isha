<!--  Start navbar  -->
<nav class="navbar navbar-expand-lg tc-navbar-st1 navbar-dark{{ request()->routeIs('home') ? ' home-navbar' : 'pages-navbar' }}">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-lg-5 ps-lg-5 me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('works') }}">Our Works</a>
                </li>
                <li class="nav-item">
